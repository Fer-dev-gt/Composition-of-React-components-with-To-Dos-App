<h1 align="center" id="title">To Do App using Component Composition</h1>
This is a refactor verion of my main To Do App, here I chosed a different way of state managing, instead of using useState inside each component I abstracted so all the props, and state setters can be send from the App Component directly, so we can have a more readable code

Try it yourself! https://fer-dev-gt.github.io/Composition-of-React-components-with-To-Dos-App/

<img width="2240" alt="Screenshot 2023-09-23 at 23 48 23" src="https://github.com/Fer-dev-gt/Composition-of-React-components-with-To-Dos-App/assets/119085740/b9b98e38-8d1f-49eb-ac75-34fd84be3c7d">
